...
```bash
npx skills add astamvalley/claude-foundation --plugin crb
```
...
```
/crb:cast CARRIER 방05 설계
/crb:cast --auto 새 앱 아키텍처 결정
```
...
- [`/crb:cast`](skills/cast/SKILL.md) — 메인 워크플로우
- [`/crb:setup`](skills/setup/SKILL.md) — 환경 세팅
