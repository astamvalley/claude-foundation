...
```json
{"session_id":"crb-YYYYMMDD-HHMMSS","command":"smelt","completed_steps":["mold"],"next_step":"forge","context":{"mold_output":".crb/outputs/crb-YYYYMMDD-HHMMSS-mold.md"},"saved_at":"<ISO8601>"}
```
...
```json
{"session_id":"crb-YYYYMMDD-HHMMSS","command":"smelt","completed_steps":["mold","forge"],"next_step":"assay","context":{"mold_output":".crb/outputs/crb-YYYYMMDD-HHMMSS-mold.md","forge_output":"<생성 파일 목록>"},"saved_at":"<ISO8601>"}
```
